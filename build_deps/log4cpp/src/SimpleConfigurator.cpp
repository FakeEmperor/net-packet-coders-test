...
namespace log4cpp {
    ...
    void SimpleConfigurator::configure(const std::string& initFileName) noexcept(false) { // throw (ConfigureFailure) {
    ...
    void SimpleConfigurator::configure(std::istream& initFile) noexcept(false) { //throw (ConfigureFailure) {

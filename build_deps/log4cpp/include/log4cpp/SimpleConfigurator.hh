...
namespace log4cpp {
    ...
    public:
         ...
         * syntax error.
         **/
        static void configure(const std::string& initFileName) noexcept(false); // throw (ConfigureFailure);
         ...
         * syntax error.
         **/
        static void configure(std::istream& initFile) noexcept(false); /*throw (ConfigureFailure);*/    };
}
